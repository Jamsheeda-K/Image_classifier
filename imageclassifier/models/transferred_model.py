...
model_saved = keras.models.load_model('C:/Jamsheeda/Spiced_projects/week_9/Project/imageclassifier/models/7classifier_completedata.h5')
def predict_class(my_image):
    ...
    y_pred = model_saved.predict(processed_pic).round(3)
